                          ...
                          <div class="card-content collapse show">
                              <div class="card-body card-dashboard">
                                <div class="selectSearch">
                                    <h3 class="card-text">Journalist</h3>
                                </div>
                                      ...
                                      @foreach($users as $user)
                                          <tr>
                                              ...
                                              <td>
                                               ...
                                               <a class="btn btn-danger btnInfo" onclick="return confirm('Are you sure?')" href="{{route('users.delete',$user->id)}}" data-toggle="tooltip" data-placement="top" title="Delete"><i class="ft-trash-2"></i></a>
                                              </td>
                                          </tr>
